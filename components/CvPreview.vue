  ...
  >
      ...
      <div class="cv__side w-1/3">
        ...
        <section class="cv__section">
          ...
          <div class="flex flex-col">
            ...
            <div v-if="formSettings.githubRepo" class="cv__icon-wrapper">
              <svg class="cv__icon">
                <use href="@/assets/sprite.svg#github-color"></use>
              </svg>
              <a
                target="_blank"
                rel="noopener"
                :href="`https://github.com/${formSettings.githubRepo}`"
                >{{ `github.com/${formSettings.githubRepo}` }}</a
              >
            </div>
            <div v-if="formSettings.gitlab" class="cv__icon-wrapper">
              <svg class="cv__icon">
                <use href="@/assets/sprite.svg#gitlab-color"></use>
              </svg>
              <a
                target="_blank"
                rel="noopener"
                :href="`https://gitlab.com/${formSettings.gitlab}`"
                >{{ `gitlab.com/${formSettings.gitlab}` }}</a
              >
            </div>
    ...
    >
      ...
      <a
        ...
        href="https://github.com/Marissccal "
        rel="noopener"
        target="_blank"
        >hernanabeldaño</a
      >
