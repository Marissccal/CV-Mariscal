          ...
          <template v-slot:content>
            <div class="grid grid-cols-2 gap-x-3 gap-y-10">
              ...
              <div class="form__group col-span-full">
                ...
                <input
                  id="githubRepo"
                  v-model="formSettings.githubRepo"
                  class="form__control"
                  type="text"
                />
              </div>
              <div class="form__group col-span-full">
                <label class="form__label flex" for="gitlab">
                  <svg class="form__icon mr-1">
                    <use href="@/assets/sprite.svg#gitlab"></use>
                  </svg>
                  GitLab
                </label>
                <input
                  id="github"
                  v-model="formSettings.gitlab"
                  class="form__control"
                  type="text"
                />
              </div>
